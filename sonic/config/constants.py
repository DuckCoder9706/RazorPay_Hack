...
C_RETRY_PAISE: int = _cfg_int("SONIC_C_RETRY_PAISE", 0)
C_CHURN_PAISE: int = _cfg_int("SONIC_C_CHURN_PAISE", 500)
CHURN_SWEEP_PAISE: tuple[int, ...] = (0, 250, 500, 1000, 2000)

CUSTOMER_VALUE_MULTIPLIER: dict[str, float] = {"low": 0.5, "mid": 1.0, "high": 2.0}

MAX_RETRY_ATTEMPTS: int = _cfg_int("SONIC_MAX_ATTEMPTS", 3)
SPEND_CAP_PAISE: int = _cfg_int("SONIC_SPEND_CAP_PAISE", 0)
NET_VALUE_FLOOR_PAISE: int = _cfg_int("SONIC_NET_FLOOR_PAISE", 0)

CALIBRATION_N_MIN: int = _cfg_int("SONIC_CAL_N_MIN", 20)
